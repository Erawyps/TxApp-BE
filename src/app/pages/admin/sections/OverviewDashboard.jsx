  ...
  const statCards = [
    {
      ...
      stats: [
        ...
        { label: 'Actifs', value: stats.users.active, color: 'text-green-600' },
    ...
    },
    {
      ...
      stats: [
        { label: 'Total', value: stats.drivers.total, color: 'text-gray-900' },
        { label: 'Actifs', value: stats.drivers.active, color: 'text-green-600' },
        { label: 'Inactifs', value: stats.drivers.inactive, color: 'text-red-600' }
      ]
    },
    {
      title: 'Véhicules',
      ...
      stats: [
        { label: 'Total', value: stats.vehicles.total, color: 'text-gray-900' },
        { label: 'Actifs', value: stats.vehicles.active, color: 'text-green-600' },
        { label: 'Maintenance', value: stats.vehicles.maintenance, color: 'text-yellow-600' }
      ]
    },
    {
      title: 'Clients',
      ...
      stats: [
        { label: 'Total', value: stats.clients.total, color: 'text-gray-900' },
        { label: 'Actifs', value: stats.clients.active, color: 'text-green-600' },
        { label: 'Inactifs', value: stats.clients.inactive, color: 'text-red-600' }
      ]
    }
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Tableau de bord général de l&apos;administration</p>
        </div>
        <Button
