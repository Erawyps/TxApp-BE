...
export const PrintReport = forwardRef(({ shiftData, courses, driver, vehicle }, ref) => {
  ...
  return (
    <div ref={ref} className="bg-white text-black p-8" style={{ fontFamily: 'Times New Roman, serif', fontSize: '12px' }}>
      ...
      <div className="flex justify-between mb-4">
        <div>
          ...
          <span className="border-b border-black inline-block w-32 text-center">
            {shiftData?.date ? new Date(shiftData.date).toLocaleDateString('fr-FR') : new Date().toLocaleDateString('fr-FR')}
          </span>
        </div>
        <div>
      ...
      {/* Service - Table avec vérification des données */}
      <div className="mb-4">
      ...
      {/* Courses avec gestion des données vides */}
      <div className="mb-4">
        ...
        <table className="w-full border-collapse border border-black mt-2">
          ...
          <tbody>
            {Array.from({ length: Math.max(8, courses?.length || 0) }, (_, i) => {
              ...
              return (
                <tr key={i}>
                  ...
                  <td className="border border-black p-1 text-center text-xs">
                    {formatNumber(course?.index_depart)}
                  </td>
                  <td className="border border-black p-1 text-center text-xs">
                    {formatNumber(course?.index_embarquement)}
                  </td>
                  ...
                  <td className="border border-black p-1 text-center text-xs">
                    {formatNumber(course?.index_debarquement)}
                  </td>
                  <td className="border border-black p-1 text-xs">
